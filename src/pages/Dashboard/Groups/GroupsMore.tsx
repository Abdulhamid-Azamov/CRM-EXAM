...
const GroupsMore = () => {
    ...
    // Stack Get By Id
    const { data: moreInfo = {}, isLoading } = GetById(groupsId, cookies.token, QueryPATH.groupsMore, "/groups")
    // Stack Delete
    const { mutate: DeleteStack, isPending } = Delete(cookies.token, `/groups/${groupsId}`, navigate, queryClient, QueryPATH.groups)

    // Action qoshib qoyasiz
    // Yakun boldi endi
    return (
        <div className="p-5">
