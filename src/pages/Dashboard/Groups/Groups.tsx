  ...
  return (
    <div className="p-5">
      ...
      <div className="flex items-center gap-5 my-5">
        ...
        <CustomSelect disabled={stackPropId ? true : false} params={stackPropId ? { stackId: stackPropId } : {}} placeholder="Yo'nalish tanlang" URL="/stacks" queryKey={QueryPATH.stacks} value={stackId} setValue={setStackId} />
        <CustomSelect disabled={teacherPropId ? true : false} placeholder="Ustoz tanlang" URL="/teachers" queryKey={QueryPATH.teachers} setValue={setTeacherId} value={teacherId} />
      </div>
